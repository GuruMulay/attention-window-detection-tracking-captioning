...
class video:
    ...
    def initialFraming(self,path):
        ...
        print height, width, self.numberOfSamples

        samples = np.array([[0 for x in range(0,self.numberOfSamples)] for x in range(0,(height*width))])
        # samples = np.array([[0 for x in range(0,self.numberOfSamples)] for x in range(0,(921600))])
